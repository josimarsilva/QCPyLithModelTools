...
filename='step01-fault_t0000000.vtk'
...
with open(InputFileNamesAll) as f:
    for line in f:
        ...
        pythonCalculator1.Expression = "inputs[1].PointData['slip'] - inputs[0].PointData['slip']"
        ...
        #File Name to Save
        OutputName='Fault_Diff_JS_Slip_t_'+str(countTime)+'.vtk'
        ...
        GPSfileName='Fault_Slip.'+str(countTime)+'.csv'
