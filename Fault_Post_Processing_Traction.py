...
with open(InputFileNamesAll) as f:
    for line in f:
        ...
        pythonCalculator1.Expression = "inputs[1].PointData['traction']"
        pythonCalculator1.ArrayName='Traction_JS'
        ...
        #File Name to Save
        OutputName='Fault_Diff_JS_Traction_t_'+str(countTime)+'.vtk'
        ...
        GPSfileName='Fault_Traction.'+str(countTime)+'.csv'
