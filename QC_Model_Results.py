...
def main():
    ...
    data.LoadGPSdataLargeData( mainDir)
    ...
    #data.LoadFaultTractionLargeData(mainDir)
    ...
    data.Time=Time
    beginyear=155500; endyear=158500      #For AGU analysis

    #beginyear=0; endyear=170000
    #beginyear=156000; endyear=158000
    #beginyear=155000; endyear=170000
    
    #beginyear=150000; endyear=170000
    #beginyear=156200; endyear=156800
    #beginyear=156200; endyear=159000
    #beginyear=156200; endyear=156250
    #beginyear=130000; endyear=154000
    #beginyear=154800; endyear=157000
    ...
    #####Here I create the Slip weakening friction coefficients
    #mu_s=0.8 #Initial value for the friction coefficient
    #mu_d=0.7
    #stdInput=14
    ...
    #GPSintercept=np.array([0,  75, 150]) # Final Resutl Interseismi deformation
    GPSintercept=np.array([0,  0, 0]) # Final Resutl Interseismi deformation
    ...
    OutputDir=mainDir+'Figures/'
    FigName='GPS_displacement'
    #data.PlotDisplacementTimeSeries(OutputDir, FigName)     #Only plot this if you want to see the entire domain. Be careful to not ovewrite.
    ...
    for imax in data.SSEindex[:,1]:
        ...
        lns3 = ax[0].plot(data.FaultX[:,0]/1e3, data.mu_f_d[:],'-r',linewidth=2,label='$\mu_d$')
